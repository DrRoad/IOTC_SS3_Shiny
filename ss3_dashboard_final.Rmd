...
### AEN TO DO: Is there a way to have a sidplebar for each page whose options are linked to all pages?
##             Add another model run for each spp!! (how to change line colors, etc for other runs??)
...
selectizeInput(inputId='Model',label='Select from the species models currently available',
              choices=c('simple','SWO','YFT','BET'),selected='SWO',multiple = FALSE)
